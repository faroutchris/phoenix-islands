...
config :selfservice_test, SelfService.Repo,
  database: Path.expand("../selfservice_test_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :selfservice_test, SelfServiceWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/selfservice_test_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :selfservice_test, dev_routes: true
